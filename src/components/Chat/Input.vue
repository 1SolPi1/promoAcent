<template>
  <div>
   <textarea name="chat" id="chat" cols="30" rows="10" v-model="newMessage" @keydown="handleKey"></textarea>
  ...
  <button type="button" class="btn btn-primary btn_chat" @click="_submitText()">Отправить</button>
</div>
</div>
</template>
