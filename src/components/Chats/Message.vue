<template>
  <div class="sc-message">
    <div class="sc-message--content" :class="{
        sent: message.author === 0,
        received: message.author !== 0 && message.type !== 'system',
        system: message.type === 'system'
      }">
      <!-- <div v-if="message.type !== 'system'" :title="authorName" class="sc-message--avatar" :style="{
        backgroundImage: `url(${chatImageUrl})`
      }"></div> -->
      <TextMessage :data="message.message" :messageColors="determineMessageColors()" :messageStyling="messageStyling" />
