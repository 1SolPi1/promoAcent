<template>
  <div class="answ-wrap">
    <div class="good-bad" v-if="creator">
      <div class="item_sorting" v-if="!answers.answer.best">
        <input 
          type="checkbox" 
          name="checkbox" 
          class="checkbox" 
          id="checkbox" 
          :checked="answers.answer.best" 
          @click="setBestAnswer()"
          >
          <label for="checkbox">
    ...
    <div class="item_sorting" v-else>
      ...
      <div class="sorting_questions">
        ...
        <div class="image_expert ">
          ...
          <div class="rating_expert">{{rating}}</div>
...
<script>
  export default {
    ...
    props: {
      ...
      date:{
        type: String,
        default: '01 Июня 2019'
      },
      avatar:{
        type: String,
        default: '/img/expert2.png'
      },
      rating:{
        type: Number,
        default: 5
    ...
    methods: {
      ...
      let params = new URLSearchParams();
        ...
        this.$http({
          method: 'POST',
          url: 'question/question/best-answer',
          data: params,
          headers: { 
    ...
    computed: {
      ...
      creator(){
        return this.$store.getters.USERINFO.id === this.questionid
      }
    },
  }
</script>
