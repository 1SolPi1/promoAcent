							...
							<div class="section_content_tabs">
								<div class="tab-content">
										<div class="clearfix friends_bonuses">
											<div class="ritem">Вы пригласили <span>1</span> друзей</div>
											<div class="ritem">Заработали <span>20₽</span></div>
											<div class="ritem">Получили <span>1</span> бесплатных VIP вопросов</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-12 col-md-7">
												<div class="fr-block">
													...
													<form action="">
														<input placeholder="адрес получателя" type="text">
